    ...
    <section id = 'portfolio'>
      ...
      <div className='container portfolio_container'>
        <article className='portfolio_item'>
          ...
          <h3><span style={{ position:'relative', right: '4px', fontSize: 'small' }}>Weather App</span></h3>
        ...
        <article className='portfolio_item'>
          ...
          <h3><span style={{ position: 'relative', fontSize: 'small' }}>Far Out Fairway</span></h3>
          <div className='portfolio_item-cta'>
        ...
        <article className='portfolio_item'>
          ...
          <h3><span style={{ position:'relative', right: '7px', fontSize: 'small' }}>Labyrinth Game</span></h3>
          <div className='portfolio_item-cta'>
